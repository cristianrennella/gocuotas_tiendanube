(() => {
  if (window.location.pathname.includes('/productos/')) {
    ...
    var newSpanForGocuotasDescription = document.createElement("span");
    newSpanForGocuotasDescription.classList.add('js-max-installments-container', 'js-max-installments', 'col-12', 'mb-2');
      ...
      newSpanForPaymentDescription.classList.add('float-left', 'mr-2');
        ...
        if (svg_format_option) {
          ...
          var newSvgForPayment = document.createElementNS("http://www.w3.org/2000/svg", "svg");
          newSvgForPayment.classList.add('svg-inline--fa', 'fa-lg', 'svg-icon-accent', 'float-left');
          newSvgForPayment.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
          newSvgForPayment.setAttribute('viewBox', '0 0 576 512');
    ...
    newSpanForGocuotasDescription.appendChild(newSpanForPaymentDescription);
    newSpanForGocuotasDescription.appendChild(newSpanForSubPaymentDescription);

    var payment_placement_options = document.querySelector('.js-max-installments-container');

    if (payment_placement_options) {
      console.log("Payment Placemente Option: 3")
      payment_placement_options.insertAdjacentElement('afterend', newSpanForGocuotasDescription);
      return;
    }
  }
})();