(() => {
  if (window.location.pathname.includes('/productos/')) {
    ...
    newDivForGocuotasDescription.classList.add('js-max-installments-container', 'installments', 'm-bottom-quarter');
      ...
      newDivForSubPaymentDescription.innerHTML = "Hasta <strong>6</strong>  cuotas SIN interés con <strong>tarjeta de DÉBITO</strong>";
    ...
    newDivForGocuotasDescription.classList.add('js-max-installments-container', 'row-fluid');
      ...
      newSubDivForPaymentDescription.innerHTML = "Hasta <strong>6</strong>  cuotas SIN interés con <strong>tarjeta de DÉBITO</strong>";
    ...
    // Option 3 for Tiendanube Theme
      ...
      newSpanForSubPaymentDescription.classList.add('js-max-installments-container','js-max-installments','product-detail-installments','d-table');
        ...
        newSpanForInstallment.innerHTML = "Hasta <span class='text-accent font-weight-bold'>6</span>  cuotas SIN interés con <span class='text-accent font-weight-bold'>tarjeta de DÉBITO</span>";
