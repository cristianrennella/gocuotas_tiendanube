(() => {
    ...
    if (window.location.pathname.includes('/productos/') && window.location.pathname != 'productos') {
        ...
        if (installmentsSubtitle_1) {
          installmentsSubtitle_1.textContent = 'Pagá en 2 y 3 cuotas SIN interés con DÉBITO';
        }
        ...
        if (installmentsSubtitle_2) {
          installmentsSubtitle_2.textContent = 'Pagá en 2 y 3 cuotas SIN interés con DÉBITO';
        }
        ...
        if(installmentsTitle_4.length > 0){
          ...
          installmentsTitle_4[1].textContent = "Pagá en 2 y 3 cuotas SIN interés con DÉBITO"
        }
    }
})();